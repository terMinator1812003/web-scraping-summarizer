...
# Adding arguments
parser.add_argument('--web', type=str, help='website link (default : https://www.geeksforgeeks.org/0-1-knapsack-problem-dp-10/)', default="https://www.geeksforgeeks.org/0-1-knapsack-problem-dp-10/")
